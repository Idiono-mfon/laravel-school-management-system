    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="classes" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('class_arm')}}"> Class Arms </a>
                    </li>
                    <li>
                        <a href="{{ route('classes') }}"> All Classes </a>
                    </li>
                    <li>
                        <a href="{{ route('class_subjects') }}"> Class Subjects </a>
                    </li>
